...
const featuredReviews = [
  {
    ...
    image: '', // no photo on file — card shows its designed initials fallback
  },
  {
    name: 'bailey graven',
...
const communityImages = [
  '/assets/community/595809938_911561951195537_7697025094399662061_n.webp',
  '/assets/community/709054272_122297092346074441_611339033472914512_n.webp',
  '/assets/community/723240798_1581981947261953_725007908264585735_n.webp',
  ...
  '/assets/community/690881861_1736994677262179_4703392938483456778_n.webp',
            ...
            >
              ...
              <div className="pt-4 border-t border-primary/10">
                ...
                <div className="flex gap-4 mb-10">
                  <a href="https://www.facebook.com/HomeFrontBuilderstn/" target="_blank" rel="noopener noreferrer" aria-label="Homefront Builders Facebook" className="w-10 h-10 rounded-full bg-primary/5 border border-primary/10 flex items-center justify-center hover:bg-[#c9a96e] hover:text-white transition-colors text-primary">
                    <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                  </a>
                  <a href="https://www.instagram.com/homefrontbuilderstn/" target="_blank" rel="noopener noreferrer" aria-label="Homefront Builders Instagram" className="w-10 h-10 rounded-full bg-primary/5 border border-primary/10 flex items-center justify-center hover:bg-[#c9a96e] hover:text-white transition-colors text-primary">
