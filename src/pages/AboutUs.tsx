...
const partners = [
  ...
  },
  {
    ...
    bio: `Growing up in the construction industry, Carissa Ockey developed an early appreciation for the craftsmanship, vision, and attention to detail required to create exceptional homes. Over the past six and a half years, she has built her career in new construction, guiding projects from initial concept through completion with a commitment to quality, design excellence, and seamless execution.\n\nWith a background in interior design, Carissa brings a unique perspective to every project. She looks beyond floorplans and finishes to thoughtfully consider how a home will live, function, and feel for the families who call it home. Her approach blends timeless aesthetics with purposeful design, creating spaces that are both sophisticated and highly livable.\n\nKnown for her collaborative nature and dedication to client relationships, Carissa believes the most successful projects are built on trust, communication, and a shared vision. She is passionate about helping homeowners navigate the building process with confidence, ensuring every detail reflects their lifestyle while maintaining the highest standards of craftsmanship and design.\n\nHer goal is simple: to help create homes that are as beautiful in their everyday functionality as they are in their architectural presence.`,
    social: { facebook: 'https://www.facebook.com/HomeFrontBuilderstn/', instagram: 'https://www.instagram.com/homefrontbuilderstn/', linkedin: '#' },
    video: '',
  },
  {
  ...
  },
  {
    ...
    bio: `With over 5 years of real estate experience and more than $25 million in closed sales, Kenneth Wotring has earned a reputation as a trusted name in the Clarksville market. A dedicated real estate professional, he is committed to helping buyers find the perfect place to call home and assisting sellers in marketing and selling their properties quickly and efficiently. Specializing in single-family homes, land, and new construction, Kenneth guides clients through every stage of the home-building process—from selecting a floor plan to the exciting day they receive the keys to their brand-new home.\n\nA retired military veteran, Kenneth served 13 years in the United States Military before choosing to put down roots in Clarksville, Tennessee, with his wife and son. His own experience building a home sparked a passion for real estate and inspired him to help others navigate one of the most important investments of their lives. He takes special pride in guiding fellow service members and their families—whether they're relocating, retiring, or putting down roots of their own.\n\n"My enthusiasm for helping others find the perfect home for their family's future allows me to connect with clients and provide the highest level of service possible."\n\nHe is especially passionate about helping active-duty military members, veterans, and their families successfully navigate the home-buying process. Having personally experienced the challenges and stress that come with military relocations, he understands the unique needs of service members and is dedicated to making each transition as smooth and stress-free as possible.\n\nKenneth's dedication has not gone unnoticed. He was named 2024 Agent of the Year at Byers & Harvey and closed $7 million in total sales volume in 2025. His strong relationships with local builders give his clients access to exclusive insights and opportunities, and with 46 seller-side deals and over $19 million in listings sold, he is a proven advocate for homeowners looking to make a move.\n\nA proud pillar of his community, Kenneth currently serves as Chair of the Government Affairs Committee, staying engaged with the policies and progress that shape local housing and growth. He holds a range of professional designations—ABR® (Accredited Buyer Representative), MRP® (Military Relocation Professional), SRS® (Seller Representative Specialist), and CRS® (Certified Residential Specialist)—along with his Luxury Home Certification (LHC) and Certified Divorce Specialist (CDS) designation. He is also a 2025 graduate of the Tennessee REALTORS® A.R.E.A. Leadership Program and a 2026 graduate of the Clarksville Association of REALTORS® Leadership Academy.\n\nWhether you're purchasing your first home, building your dream home from the ground up, relocating to the area, or preparing to sell your current property, Kenneth is committed to providing expert guidance, exceptional service, and a seamless real estate experience from start to finish.`,
    social: { facebook: 'https://www.facebook.com/HomeFrontBuilderstn/', instagram: 'https://www.instagram.com/homefrontbuilderstn/', linkedin: '#' },
  ...
  },
  {
    ...
    bio: `As a devoted husband and father, family is the driving force behind everything Chris does. While his family is his "why," his passion for real estate was shaped long before he became a husband and father. Growing up, Chris experienced the hardship of multiple evictions and spent his entire seventh-grade year living in a car. Those early experiences instilled in him a deep appreciation for the stability that homeownership provides and inspired a lifelong mission to help others achieve it.\n\nAs a first-generation homeowner, Chris understands firsthand the transformational impact of owning a home. Since launching his real estate career in 2022, he has helped more than 210 families confidently navigate the buying and selling process, earning a reputation for exceptional service, unwavering integrity, and results-driven guidance.\n\nPrior to real estate, Chris proudly served eight years in the United States military, completing six overseas deployments. His military service cultivated the discipline, resilience, accountability, and calm-under-pressure approach that now defines every client experience. Whether negotiating contracts, solving complex challenges, or guiding clients through major decisions, he is committed to delivering clear communication and dependable leadership every step of the way.\n\nChris's philosophy is centered on service above sales. He believes clients deserve honest advice rather than pressure, transparency over persuasion, and guidance that prioritizes their best interests above all else. His success in the industry allows him to remain focused on what is right for each family—not simply on closing another transaction.\n\nFor Chris, real estate is about far more than buying or selling property. It is about helping families build stability, create lasting wealth, and achieve the dream of homeownership that once seemed out of reach for his own family. Every relationship is built on trust, integrity, and a genuine commitment to helping clients lay the foundation for their future.`,
    social: { facebook: 'https://www.facebook.com/HomeFrontBuilderstn/', instagram: 'https://www.instagram.com/homefrontbuilderstn/', linkedin: '#' },
    video: '',
  },
  {
      ...
      <section className="pb-20 md:pb-28 px-6 md:px-12 relative z-20 -mt-16 md:-mt-24">
        <div className="max-w-[1000px] mx-auto">
          ...
          >
            ...
            >
              <source src="https://www.dropbox.com/scl/fi/h45dv3jrz8kyljlcrfi3c/Homefront-Planning-Stage.mp4?rlkey=r7ehptb96ssw18c2ox0m907dy&raw=1" type="video/mp4" />
