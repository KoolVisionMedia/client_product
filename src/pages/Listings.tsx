...
const listings = [
  ...
  {
    name: '18 Fawn Meadows',
    location: '18 Fawn Meadows',
    price: 'Sold',
    stats: 'The Sycamore',
    description: "This magnificent Sycamore model at 18 Fawn Meadows delivers an extraordinary living experience. The home features a flowing open-concept design, premium custom cabinetry, quartz countertops, luxury vinyl plank flooring, and an inviting outdoor living space. A true testament to the quality and attention to detail that defines every Homefront home.",
    image: '/assets/active_listings/18-fawn-meadows-sycamore/1.jpg',
    images: [
      '/assets/active_listings/18-fawn-meadows-sycamore/1.jpg',
      '/assets/active_listings/18-fawn-meadows-sycamore/2.jpg',
      ...Array.from({length: 78}, (_, i) => `/assets/active_listings/18-fawn-meadows-sycamore/NEWKoolVisionMedia${String(i + 2).padStart(3, '0')}.jpg`)
        .filter((_, idx) => ![1, 2, 5, 6].includes(idx)),
    ],
    status: 'Sold',
  },
  {
    name: '24 Fawn Meadows',
    location: '24 Fawn Meadows',
    price: 'Sold',
    stats: 'The Cypress',
    description: "An exquisite Cypress model home at 24 Fawn Meadows, showcasing impeccable craftsmanship and designer-curated interiors. This property features soaring ceilings, an open gourmet kitchen, custom millwork, and a luxurious primary retreat. The professionally landscaped exterior and covered outdoor living areas provide the perfect setting for relaxation and entertainment.",
    image: '/assets/active_listings/24-fawn-meadows-cypress/2_dsc01535.jpg',
    images: [
      '/assets/active_listings/24-fawn-meadows-cypress/2_dsc01535.jpg',
      '/assets/active_listings/24-fawn-meadows-cypress/4_dsc01530.jpg',
      '/assets/active_listings/24-fawn-meadows-cypress/6_dsc01545.jpg',
      '/assets/active_listings/24-fawn-meadows-cypress/7_dsc01550.jpg',
      '/assets/active_listings/24-fawn-meadows-cypress/9_dsc01560.jpg',
      '/assets/active_listings/24-fawn-meadows-cypress/14_dsc01585.jpg',
      ...Array.from({length: 56}, (_, i) => `/assets/active_listings/24-fawn-meadows-cypress/${i + 15}_koolvisionmedia${String(i + 99).padStart(3, '0')}.jpg`),
    ],
    status: 'Sold',
  },
  {
