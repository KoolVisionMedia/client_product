...
const listings = [
  ...
  },
  {
    ...
    price: '$1,200,000',
    stats: '4 Bed • 3.5 Bath • 3,500 SqFt • 2.10 Acres',
    description: "An exceptional to-be-built custom estate in the Holders Ridge community, 2 Pace Road (Lot 2) offers 3,500 square feet of luxury living with 4 bedrooms and 3.5 bathrooms on a generous 2.10-acre homesite in Montgomery County. This Homefront Builders new construction is designed for elegant everyday living and effortless entertaining, featuring an open-concept layout and premium finishes throughout. (MLS# 3159639 · representative photo)",
    image: '/assets/to-be-built-bg.jpg',
  ...
  },
  {
    ...
    location: 'Holders Ridge, Clarksville TN 37043',
    price: '$1,079,900',
    stats: '4 Bed • 4 Bath • 3,200 SqFt • 1.85 Acres',
    description: "Now to be built in the sought-after Holders Ridge community, 4 Pace Road (Lot 4) is a spacious 4-bedroom, 4-bathroom custom home spanning 3,200 square feet on a 1.85-acre lot in Montgomery County. Built by Homefront Builders, this home showcases high-end finishes, an open-concept design, and the superior craftsmanship the team is known for. Estimated completion December 2026. (MLS# 3158985 · representative photo)",
    image: '/assets/to-be-built-bg.jpg',
    images: ['/assets/to-be-built-bg.jpg'],
    status: 'Coming Soon',
  },
  {
    ...
    location: 'Holders Ridge, Clarksville TN 37043',
    price: '$799,900',
    stats: '4 Bed • 2.5 Bath • 2,430 SqFt • 2.41 Acres',
    description: "To be built in the sought-after Holders Ridge community, 3 Pace Road is a 4-bedroom, 2.5-bathroom custom home offering 2,430 square feet of thoughtfully designed living space on a private 2.41-acre homesite in Montgomery County. This Homefront Builders new construction blends premium craftsmanship with functional, modern living. Estimated completion December 2026. (MLS# 3152353 · representative photo)",
    image: '/assets/to-be-built-bg.jpg',
    images: ['/assets/to-be-built-bg.jpg'],
    status: 'Coming Soon',
  },
