        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 mb-20">
          ...
          <div className="lg:col-span-5">
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.facebook.com/HomeFrontBuilderstn/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-10 h-10 rounded-full border border-white/15 flex items-center justify-center text-white/40 hover:text-[#c9a96e] hover:border-[#c9a96e] transition-all duration-300">
              ...
              <a href="https://www.instagram.com/homefrontbuilderstn/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full border border-white/15 flex items-center justify-center text-white/40 hover:text-[#c9a96e] hover:border-[#c9a96e] transition-all duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
              </a>
              <a href="https://www.tiktok.com/@homefront.builder" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-10 h-10 rounded-full border border-white/15 flex items-center justify-center text-white/40 hover:text-[#c9a96e] hover:border-[#c9a96e] transition-all duration-300">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 font-sans text-xs text-white/60 tracking-widest uppercase">
              ...
              <li><Link to="/listings" className="hover:text-[#c9a96e] transition-colors">Listings</Link></li>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 font-sans text-xs text-white/60 tracking-widest uppercase">
              ...
              <li><Link to="/floorplans" className="hover:text-[#c9a96e] transition-colors">Floor Plans</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-5 font-sans text-xs text-white/60 tracking-wide leading-loose">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:homefrontsalesTN@gmail.com" className="hover:text-[#c9a96e] transition-colors">homefrontsalesTN@gmail.com</a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="tel:9312212566" className="hover:text-[#c9a96e] transition-colors">(931) 221-2566</a>
              </li>
            </ul>
          </div>
        </div>
